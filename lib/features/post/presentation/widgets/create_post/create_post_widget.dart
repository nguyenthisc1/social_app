...
import 'package:social_app/features/post/presentation/widgets/create_post/create_post_story_widget.dart';
      ...
      children: [
        ...
        Positioned.fill(
          child: PageView(
            ...
            children: [
              // const CreatePostNewsWidget(),
              BlocProvider(
                create: (_) => StoryBloc(),
                child: const CreatePostStoryWidget(),
              ),
            ],
          ),
        ),
            ...
            child: Stack(
              ...
              children: [
                ...
                Positioned(
                  ...
                  bottom: 0,
                  child: isStory
                      ? Icon(LucideIcons.switchCamera, color: Colors.white)
                      : const SizedBox(width: 24),
                ),
              ],
            ),
